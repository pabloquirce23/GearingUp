...
if(isset($_POST['cat_add_req'])){
    ...
    $sql= "insert into character_category(name) values('$category_name')";
...
if(isset($_POST['cat_edit_req'])){
    ...
    $sql= "update character_category set name='$category_name' where id='$edit_id'";
    if(mysqli_query($conn, $sql)){
    echo '
        <div class="alert alert-success alert-dismissible" role="alert">
          <span type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></span>
...
<div class="app-main__inner">
    <div class="card">
        ...
        <?php if(isset($_GET['edit_rq'])){ 
            ...
            $sql= "select * from character_category where id='$edit_id'";
