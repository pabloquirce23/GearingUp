...
while ($category= mysqli_fetch_assoc($result)) { $no++ ?>
                    <tr>
                        ...
                        <td><a href="character_category_add.php?edit_rq=<?php echo $category['id'] ?>" class="btn btn-warning">Edit</a></td>
                        <td><a href="config/category_config.php?character_category_delete_id=<?php echo $category['id'] ?>" class="btn btn-danger">Delete</a></td>
                    </tr>
<?php } ?>
                </tbody>
            </table>
